...
ActiveRecord::Schema.define(version: 20_200_509_123_929) do
  ...
  create_table 'attendances', force: :cascade do |t|
    ...
    t.index %w[attendable_id training_id], name: 'index_attendances_on_attendable_id_and_training_id'
  ...
  create_table 'players_teams', id: false, force: :cascade do |t|
    ...
    t.index %w[team_id player_id], name: 'index_players_teams_on_team_id_and_player_id'
  end
  ...
  create_table 'teams_trainings', id: false, force: :cascade do |t|
    t.bigint 'team_id', null: false
    t.bigint 'training_id', null: false
    t.index %w[team_id training_id], name: 'index_teams_trainings_on_team_id_and_training_id'
  end
